...
class ViewController: UIViewController  {
    ...
    override func viewDidLoad() {
        ...
        firstbtn.setTitleColor(UIColor.blue, for: .highlighted)
        
        secondbtn.setTitleColor(UIColor.white, for:.normal)
        secondbtn.setTitleColor(UIColor.blue, for: .highlighted)
        
        thirdbtn.setTitleColor(UIColor.white, for: .normal)
        thirdbtn.setTitleColor(UIColor.blue, for:.highlighted)
        
        fourthbtn.setTitleColor(UIColor.white, for: .normal)
        fourthbtn.setTitleColor(UIColor.blue, for: .highlighted)
        ...
        imgOne.image = UIImage(named: "g1")
        
        let imgTwo = UIImageView(frame: CGRect(x:imgOne.frame.origin.x + imgOne.frame.width ,
                                               y:0 ,
                                               width:scrollViewWidth,
                                               height:scrollViewHeight))
        imgTwo.image = UIImage(named: "g2")
        
        let imgThree = UIImageView(frame: CGRect(x:imgTwo.frame.origin.x + imgTwo.frame.width ,
                                                 y:0,width:scrollViewWidth,
                                                 height:scrollViewHeight))
        imgThree.image = UIImage(named: "g3")
        
        let imgFour = UIImageView(frame: CGRect(x:imgThree.frame.origin.x + imgThree.frame.width,y:0,
                                                width:scrollViewWidth,
                                                height:scrollViewHeight))
                                
        imgFour.image = UIImage(named: "g4")
